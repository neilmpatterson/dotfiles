...
## Mandatory Two-Phase Workflow (Gitflow-integrated)
...
1. **Analyze the feature** to identify:
   ...
   - Gitflow branching strategy (feature branch from develop)

2. **Create a subtask plan** with:
   - Feature slug (kebab-case)
   - Clear task sequence and dependencies
   - Exit criteria for feature completion
   - Branching plan (feature branch naming, merge strategy)
...
- Include git commit messages for each step
